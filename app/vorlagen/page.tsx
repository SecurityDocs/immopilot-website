...
const categories = [
  {
    ...
    templates: [
      ...
      {
        slug: "selbstauskunft-mieter",
        title: "Selbstauskunft Mieter",
        desc: "Formular zur Mieterauswahl vor Vertragsabschluss — mit Angaben zu Einkommen, Beruf, Kreditwürdigkeit und SCHUFA-Einwilligung. DSGVO-konform.",
        badge: "Mieterauswahl",
        pages: "2 Seiten",
      },
    ],
  },
  {
    ...
    templates: [
      ...
      },
      {
        ...
        desc: "Pflichtdokument nach §19 BMG für die Anmeldung beim Einwohnermeldeamt — muss innerhalb von 2 Wochen nach Einzug vorgelegt werden.",
        badge: "Pflicht",
        pages: "1 Seite",
      },
    ],
  ...
  },
  {
    ...
    templates: [
      ...
      {
        slug: "abmahnung-mieter",
        title: "Abmahnung Mieter",
        desc: "Abmahnung wegen Zahlungsverzug, Lärmbelästigung oder Hausordnungsverstößen — Pflichtschritt vor fristloser Kündigung nach §543 BGB. 3 Varianten.",
        badge: "3 Varianten",
        pages: "2 Seiten",
      },
      {
        slug: "kuendigung-durch-mieter",
        title: "Kündigung Mietvertrag durch Mieter",
        desc: "Formales Kündigungsschreiben mit korrekter Fristberechnung — 3 Monate zum Ende eines Kalendermonats, Versand per Einschreiben erforderlich.",
        badge: null,
        pages: "2 Seiten",
      },
    ],
