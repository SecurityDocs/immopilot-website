...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Zahlungsabgleich Miete",
    "Mahnwesen Vermieter",
    "Mieterportal",
    "Hausverwaltung ohne Verwalter",
    "Eigentümer Software",
    "DSGVO Immobilienverwaltung",
    "Immobilien verwalten ohne Hausverwaltung",
    "Mietpreisanalyse Software",
  ...
  alternates: {
    canonical: "https://www.immopilot.de",
  },
};
  ...
  return (
    <html lang="de" className={`${inter.variable} scroll-smooth`}>
      <head>
        ...
        <link rel="canonical" href="https://www.immopilot.de" />
      </head>
